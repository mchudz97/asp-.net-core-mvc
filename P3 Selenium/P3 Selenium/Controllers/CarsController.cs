...
namespace P3_Selenium.Controllers
{
    public class CarsController : Controller
    {
        ...
        public CarsController(P3_SeleniumContext context)
        {
            _context = context;
        }
        ...
        {
            var p3_SeleniumContext = _context.Car.Include(c => c.Brand);
            return View(await p3_SeleniumContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ModelName,BrandId")] Car car)
        {
